 ...
 */
export declare function setErrorResponse<T, TResponseData extends ResponseData<T>>(form: FormStore<T, TResponseData>, _formErrors: FormErrors, { duration }: ErrorResponseOptions): void;
export {};
